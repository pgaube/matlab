...
startjd=2450821
endjd=2454832
path_in='/Volumes/matlab/data/mld/mat/MLD_25_8D_'
path_out='/Volumes/matlab/data/mld/mat/MLD_25_30_'
dt=30
METHOD='none_mask_0'
...
%now write output
    for m=1:length(interp_jdays)
        ...
        eval(['save ' fname ' *' data_out ' lon lat'])
    end
