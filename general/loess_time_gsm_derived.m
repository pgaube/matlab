...
startjd=2450821%2450849
endjd=2454832%2454832
path_in='/matlab/data/gsm/mat/GSM_9_21_'
...
beta_hp=single(nan(length(lat(:,1)),length(lon(1,:)),length(interp_jdays)));
subset_lt_chl=single(nan(length(rs),length(cs),length(jdays)));
eval([data_in ' =nan(720,1440);']);
for pp=1:M*N
