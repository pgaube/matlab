function cplot_xy(x,y,ny,ymin,ymax,ytic,yin,xmin,xmax,out_file)

% Set up paths, adjust for your machine
%

func_path = '/Volumes/matlab/calcomp/comps.f'; 
...
cd(work_path)
eval(['!sed ' char(39) 's/parameter ( ncols = 41, nrows = 41, rl = -.6, rh = .6)/parameter ( ncols = '...
