function cplot_seasonal_cycle3(data1,data2,data3,data4,minc,maxc,tic,lab,title,out_file)

% Set up paths, adjust for your machine
%

func_path = '/matlab/calcomp/seasonal_cycle3.f'; 
