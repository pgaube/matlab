function cplot_comps_cont_w_line(data1,data2,x,y,minc,maxc,dz,mincc,maxcc,out_file)

% Set up paths, adjust for your machine
%

func_path = '/Volumes/matlab/calcomp/comps_cont_w_line.f'; 
...
eval(['!sed ' char(39) 's/parameter ( mincc=-5, maxcc=-5)/parameter ( mincc=' num2str(mincc) ', maxcc=' num2str(maxcc) ')/' char(39) ' tmp33.f > tmp.f']);
