function [smoothed_data] = linx_smooth2d_f(data,SPANX,SPANY)
%
%function [smoothed_data] = smooth2d_f(DATA,SPANX,SPANY)
%
...
func_path = '/matlab/fortran/smoothers/loess2d_fill.f'; %where you
                                                           %keep
                                                           %loess2d.f

start_work_path = '/matlab/fortran/smoothers/work/';%Create this
                                                            %directory to
                                                            %work in,
                                                            %will be
                                                            %cleared at
...
eval(['!sed ' char(39) 's/span_y = 10.0/span_x = ' num2str(SPANY) ...
	  ' /' char(39) ' tmp2.f > ' func_edit_path]);


!pgf90 -O -w -o tmp_loess2d loess2d.f
