function [compa,compc] = rot_comps(ids,ids_jdays,dir,METHOD);
%function [compa,compc] = rot_comps(ids,ids_jdays,dir,METHOD);
%
...
for m=1:lj
    ...
    if any(ii)
        ...
        load([OUT_PATH OUT_HEAD num2str(jdays(m))],'sp66_cc_sample','nrbp26_sst_sample','nrssh_sample','nrraw_bp26_chl_sample','nrw_ek_sample','nrsp66_car_sample','nrraw_hp66_chl_sample','nrsp66_chl_sample','id_index');
        ...
        for pp=1:length(ii)
            ...
            cc_obs=sp66_cc_sample(r_comp,c_comp,ii(pp));
