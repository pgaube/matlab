...
%'smack',kb
if isempty(temp3) %no equals sign
...
%%%  end      
  ...
  elseif howmany==1
   if ~any(strcmp(localVar{temp6,3},var_words))
    if want_row
     out=[funstrwords{i}{temp2},'=',localVar{temp6,3},'(ones(1,',subscripts{1},'));'];
    else
     out=[funstrwords{i}{temp2},'=',localVar{temp6,3},'(ones(',subscripts{1},',1));'];
    end
   elseif strcmp(localVar{temp6,3},'character')% && length(localVar{temp6,5})>0
    ...
    if want_row
     out=[funstrwords{i}{temp2},'=zeros(1,',temp7{1},');'];
    else
     out=[funstrwords{i}{temp2},'=zeros(',temp7{1},',1);'];
    end
   end
  else
   if ~any(strcmp(localVar{temp6,3},var_words))
...
%%%          if (strcmp('snames',funstrwords{i}{temp2}))
%%%           out,goon1,tempstr,'uuuuuuuuuuu3',kb
%%%          end      
