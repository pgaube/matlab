function [compa,compc] = comps_trapped(EDDY_FILE,var);
%function [compa,compc] = comps(EDDY_FILE,var);
%
% amsre_sample        41x41x571            3839404  single              
% famsre_sample       41x41x571            3839404  single              
% foi_sample          41x41x571            3839404  single              
% lat_sample          41x41x571            3839404  single              
% lon_sample          41x41x571            3839404  single              
% nfamsre_sample      57x57x571            7420716  single              
% nfoi_sample         57x57x571            7420716  single              
% nssh_sample         57x57x571            7420716  single              
% oi_sample           41x41x571            3839404  single              
% ssh_sample          41x41x571            3839404  single       
%

OUT_HEAD   = 'TRAP_TRANS_W_';
OUT_PATH   = '/Volumes/matlab/matlab/global/trapped_trans_samp/';
