function [compa,compc] = pop_comps_rel_orgin(x,y,cyc,k,id,jdays,rad,var,HEAD);
%function [compa,compc] = pop_comps_rel_orgin(x,y,cyc,k,id,jdaysrad,var,HEAD);
...
for m=1:lj
    ...
    if exist(fname)
        data=read_pop(HEAD,num2str(ujd(m)),var,1);
    else
        continue
    end
