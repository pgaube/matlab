function pcomps_clabel(imag,cont,cax,mincont,conti,maxcont,tit,pal_code,fsize)
...
caxis(cax)
hold on
[cs,h]=contour(xi,yi,cont,[conti:conti:maxcont],'k','linewidth',2);
if any(cs)
     clabel(cs)
end
[cs,h]=contour(xi,yi,cont,[mincont:conti:-conti],'k--','linewidth',2);
if any(cs)
    clabel(cs)
end
dd=['-2';'  ';'-1';'  ';' 0';'  ';' 1';'  ';' 2'];
