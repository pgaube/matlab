...
load(['/matlab/data/gsm/mat/GSM_9_21_',num2str(jdays(m))],'nbp21_chl','sm_gchl_week')
...
shading interp
hold on
contour(fssh(2:end,2:end),[-200:4:-1],'k','LineWidth',2)
