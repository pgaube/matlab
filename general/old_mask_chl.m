clear all
chl_path = '/home/bettong/data2/data/modisa/mat/'
ssh_path = '/Volumes/matlab/data/eddy/V4/mat/'
chl_prload = '/home/bettong/data2/data/modisa/mat/CHL_4_W_2454482'
...
lon=single(lon);
    ...
    for m=1:length(mid_week_jdays)
        fnamec = [chl_path 'CHL_4_W_' num2str(mid_week_jdays(m)) '.mat'];
        ...
        idmask_4km = interp2(mlon,mlat,idmask,lon,lat,'*nearest*');
        mask_4km=nan(size(idmask_4km));
        mask_4km(~isnan(idmask_4km))=1;
        eval(['save ', fnamec, ' -append idmask_4km mask_4km']);
    end
