...
tmp_fplot(chl,mask,cran(1),cran(2),'fdcolor',[IMAGE_DIR 'chl_bdsc_'],pd,tt,'chl')

if perc>=.03
	tmp_fplot(chl,mask,cran(1),cran(2),'fdcolor',[L0_IMAGE_DIR 'chl_bdsc_'],pd,tt,'chl')
end	
