...
if per>=.18 & length(zt)<=100 & length(nav_off)<100
		sfplot(psst,mask,ran(1)+1,ran(2)+1.5,'fdcolor',[CA1_IMAGE_DIR rname '_bdsc_'],pd,tmp_time,'sst')
        sfplot(gradt,mask,fran(1),fran(2),'fdcolor',[CA1_IMAGE_DIR rname '_bz_'],pd,tmp_time,'bz')
