...
v1 = [datenum(s(1),s(2),s(3)) datenum(s(1),s(2),s(3)-2)];

[sst lon lat time] = xtracto_3D_bdap(xvec,yvec,v1,'TATssta3day');
...
fplot(gradt,mask,fran(1),fran(2),'pjet',[IMAGE_DIR 'cw3_bz_'],pd,tt,'sst')
