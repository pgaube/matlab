...
text(75,30,[num2str(round(nanmedian(obs_eddies.amp(ai_ob)))),' cm'],'fontsize',10,'color','r')
text(75,35,[num2str(round(nanmedian(obs_eddies.amp(ci_ob)))),' cm'],'fontsize',10,'color','b')
gb=subplot(132);
...
line([min(tbins) max(tbins)],[0 0],'color','k')
text(75,30,[num2str(round(nanmedian(run14_eddies.amp(ai_14)))),' cm'],'fontsize',10,'color','r')
text(75,35,[num2str(round(nanmedian(run14_eddies.amp(ci_14)))),' cm'],'fontsize',10,'color','b')
...
line([min(tbins) max(tbins)],[0 0],'color','k')
text(75,30,[num2str(round(nanmedian(run33_eddies.amp(ai_33)))),' cm'],'fontsize',10,'color','r')
text(75,35,[num2str(round(nanmedian(run33_eddies.amp(ci_33)))),' cm'],'fontsize',10,'color','b')
...
set(ga,'Position',[0.1 0.3 0.25 0.4],'fontsize',9)
line([min(tbins) max(tbins)],[0 0],'color','k')
text(150,22,[num2str(round(nanmedian(obs_eddies.radius(ai_ob)))),' km'],'fontsize',10,'color','r')
text(150,26,[num2str(round(nanmedian(obs_eddies.radius(ci_ob)))),' km'],'fontsize',10,'color','b')
...
text(150,22,[num2str(round(nanmedian(run14_eddies.radius(ai_14)))),' km'],'fontsize',10,'color','r')
text(150,26,[num2str(round(nanmedian(run14_eddies.radius(ci_14)))),' km'],'fontsize',10,'color','b')
...
set(gc,'Position',[0.7 0.3 0.25 0.4],'fontsize',9)
line([min(tbins) max(tbins)],[0 0],'color','k')
text(150,22,[num2str(round(nanmedian(run33_eddies.radius(ai_33)))),' km'],'fontsize',10,'color','r')
text(150,26,[num2str(round(nanmedian(run33_eddies.radius(ci_33)))),' km'],'fontsize',10,'color','b')
...
stairs(tbins,nc_ob,'b','linewidth',1)
axis([min(tbins) max(tbins) 0 45])
set(gca,'xtick',[1 15:15:73 73])
title('AVISO','fontsize',12)
set(ga,'Position',[0.1 0.3 0.25 0.4],'fontsize',9)
line([min(tbins) max(tbins)],[0 0],'color','k')
text(45,33,[num2str(round(nanmedian(obs_eddies.age(ai_ob)))),' weeks'],'fontsize',10,'color','r')
text(45,40,[num2str(round(nanmedian(obs_eddies.age(ci_ob)))),' weeks'],'fontsize',10,'color','b')
...
text(45,33,[num2str(round(nanmedian(run14_eddies.age(ai_14)))),' weeks'],'fontsize',10,'color','r')
text(45,40,[num2str(round(nanmedian(run14_eddies.age(ci_14)))),' weeks'],'fontsize',10,'color','b')
...
set(gc,'Position',[0.7 0.3 0.25 0.4],'fontsize',9)
line([min(tbins) max(tbins)],[0 0],'color','k')
text(45,33,[num2str(round(nanmedian(run33_eddies.age(ai_33)))),' weeks'],'fontsize',10,'color','r')
text(45,40,[num2str(round(nanmedian(run33_eddies.age(ci_33)))),' weeks'],'fontsize',10,'color','b')
