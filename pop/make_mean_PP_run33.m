...
for nn=vv; % time
    ...
    if exist(['mat/run33_',num2str(nn),'.mat'])
        load(['mat/run33_',num2str(nn)],'pp_diat','pp_diaz','pp_small')
...
save ~/matlab/pop/mat/mean_diaz_pp_run33 mean_diaz_pp
save ~/matlab/pop/mat/mean_diat_pp_run33 mean_diat_pp
save ~/matlab/pop/mat/mean_small_pp_run33 mean_small_pp


save pop_pp_means_run33 *_pp lat lon

load pop_pp_means_run33
figure(1)
clf
pmap(lon,lat,log10(diat_c))
print -dpng -r300 figs/mean_diat_pp_run33

figure(1)
clf
pmap(lon,lat,log10(diaz_c))
print -dpng -r300 figs/mean_diaz_pp_run33

figure(1)
clf
pmap(lon,lat,log10(small_c))
print -dpng -r300 figs/mean_small_pp_run33

figure(1)
clf
pmap(lon,lat,log10(diat_c+diaz_c+small_c))
print -dpng -r300 figs/mean_pp_run33
