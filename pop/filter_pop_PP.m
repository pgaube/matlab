...
fname1='/Volumes/d1/larrya/public_html/0pt1/output_run14/t.14.'; %with eddy wind
fname1='/Volumes/d1/larrya/public_html/0pt1/0pt1_run14/t.14.'; %with eddy wind
...
%             drawnow
            ...
            eval(['save -append mat/run14_',num2str(nn),' hp66_pp pp_*'])
        end 
end;
