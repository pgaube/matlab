...
load GS_rings_cor_tracks_4_week_amp_10_cm x y k id track_jday radius cyc adens 
% % % %%Basic stuff
...
% % % 
save -append pop_rings_amp_weeks_comps
% return
% %%Sources/sinks
...
% pcomps_cbar(diat_pp_c.mean,norm_ssh_c.mean,[7e-5 2.5e-4],-1,.1,1,['Diat PP',char(39) char(39),' CC'],1,20)
% print -dpng -r300 figs/pop_GS_rings_diat_pp_c
% 
% pcomps_cbar(diaz_vadv_a.mean,norm_ssh_a.mean,[-2e-7 2e-7],-1,.1,1,['Diaz PP',char(39) char(39),' AC'],1,20)
% print -dpng -r300 figs/pop_GS_rings_diaz_pp_a
% pcomps_cbar(diaz_vadv_c.mean,norm_ssh_c.mean,[-2e-7 2e-7],-1,.1,1,['Diaz PP',char(39) char(39),' CC'],1,20)
% print -dpng -r300 figs/pop_GS_rings_diaz_pp_c
% 
% pcomps_cbar(small_pp_a.mean,norm_ssh_a.mean,[3e-4 4.5e-4],-1,.1,1,['Small PP',char(39) char(39),' AC'],1,20)
% print -dpng -r300 figs/pop_GS_rings_small_pp_a
% pcomps_cbar(small_pp_c.mean,norm_ssh_c.mean,[3e-4 4.3e-4],-1,.1,1,['Small PP',char(39) char(39),' CC'],1,20)
% print -dpng -r300 figs/pop_GS_rings_small_pp_c

pcomps_cbar(diat_vadv_a.mean,norm_ssh_a.mean,[-2e-6 2e-6],-1,.1,1,['Diat vadv',char(39) char(39),' AC'],1,20)
print -dpng -r300 figs/pop_GS_rings_diat_vadv_a
pcomps_cbar(diat_vadv_c.mean,norm_ssh_c.mean,[-5e-6 5e-6],-1,.1,1,['Diat vadv',char(39) char(39),' CC'],1,20)
...
pcomps_cbar(small_graze_a.mean,norm_ssh_a.mean,[.2e-3 .45e-3],-1,.1,1,['Grazing on Small Phyto', char(39),' AC'],1,20)
print -dpng -r300 figs/pop_GS_rings_small_graze_a

pcomps_cbar(small_graze_c.mean,norm_ssh_c.mean,[.2e-3 .45e-3],-1,.1,1,['Grazing on Small Phyto', char(39),' CC'],1,20)
print -dpng -r300 figs/pop_GS_rings_small_graze_c

pcomps_cbar(diaz_graze_a.mean,norm_ssh_a.mean,[.1e-8 1e-8],-1,.1,1,['Grazing on Diaz Phyto', char(39),' AC'],1,20)
print -dpng -r300 figs/pop_GS_rings_diaz_graze_a

pcomps_cbar(diaz_graze_c.mean,norm_ssh_c.mean,[.1e-8 1e-8],-1,.1,1,['Grazing on Diaz Phyto', char(39),' CC'],1,20)
print -dpng -r300 figs/pop_GS_rings_diaz_graze_c

pcomps_cbar(small_graze_a.mean,norm_ssh_a.mean,[4e-5 4e-4],-1,.1,1,['Grazing on Diat Phyto', char(39),' AC'],1,20)
print -dpng -r300 figs/pop_GS_rings_diat_graze_a

pcomps_cbar(diat_graze_c.mean,norm_ssh_c.mean,[1e-5 2.5e-4],-1,.1,1,['Grazing on Diat Phyto', char(39),' CC'],1,20)
print -dpng -r300 figs/pop_GS_rings_diat_graze_c


pcomps_cbar(po4_a.mean,norm_ssh_a.mean,[-.03 .03],-1,.1,1,['PO_4', char(39),' AC'],1,20)
print -dpng -r300 figs/pop_GS_rings_po4_a
pcomps_cbar(po4_c.mean,norm_ssh_c.mean,[-.03 .03],-1,.1,1,['PO_4', char(39),' CC'],1,20)
print -dpng -r300 figs/pop_GS_rings_po4_c

pcomps_cbar(nh4_a.mean,norm_ssh_a.mean,[-.03 .03],-1,.1,1,['NH_4', char(39),' AC'],1,20)
print -dpng -r300 figs/pop_GS_rings_nh4_a
pcomps_cbar(nh4_c.mean,norm_ssh_c.mean,[-.03 .03],-1,.1,1,['NH_4', char(39),' CC'],1,20)
print -dpng -r300 figs/pop_GS_rings_nh4_c

pcomps_cbar(no3_a.mean,norm_ssh_a.mean,[-.6 .6],-1,.1,1,['NO_3', char(39),' AC'],1,20)
print -dpng -r300 figs/pop_GS_rings_no3_a
pcomps_cbar(no3_c.mean,norm_ssh_c.mean,[-.6 .6],-1,.1,1,['NO_3', char(39),' CC'],1,20)
...
pcomps_cbar(norm_hp66_c_c.mean,norm_ssh_c.mean,[-200 200],-1,.1,1,['C',char(39) char(39),' CC'],1,20)
...
pcomps_cbar(norm_hp66_chl_c.mean,norm_ssh_c.mean,[-.75 .75],-1,.1,1,['CHL',char(39) char(39),' CC'],1,20)
print -dpng -r300 figs/pop_GS_rings_norm_chl_c

pcomps_cbar(norm_hp66_diaz_c_a.mean,norm_ssh_a.mean,[-.1 .1],-1,.1,1,['DiazC',char(39) char(39),' AC'],1,20)
print -dpng -r300 figs/pop_GS_rings_norm_diaz_a
pcomps_cbar(norm_hp66_diaz_c_c.mean,norm_ssh_c.mean,[-.1 .1],-1,.1,1,['DiazC',char(39) char(39),' CC'],1,20)
...
pcomps_cbar(norm_hp66_diat_c_c.mean,norm_ssh_c.mean,[-.5 .5],-1,.1,1,['DiatC',char(39) char(39),' CC'],1,20)
print -dpng -r300 figs/pop_GS_rings_norm_diat_c

pcomps_cbar(norm_hp66_sp_c_a.mean,norm_ssh_a.mean,[-.1 .1],-1,.1,1,['SmallC',char(39) char(39),' AC'],1,20)
print -dpng -r300 figs/pop_GS_rings_norm_small_a
pcomps_cbar(norm_hp66_sp_c_c.mean,norm_ssh_c.mean,[-.1 .1],-1,.1,1,['SmallC',char(39) char(39),' CC'],1,20)
print -dpng -r300 figs/pop_GS_rings_norm_small_c

pcomps_cbar(small_bio_a.mean,norm_ssh_a.mean,[0 1e-4],-1,.1,1,['Small SS',char(39) char(39),' AC'],1,20)
print -dpng -r300 figs/pop_GS_rings_small_bio_a
pcomps_cbar(small_bio_c.mean,norm_ssh_c.mean,[0 1e-4],-1,.1,1,['Small SS',char(39) char(39),' CC'],1,20)
print -dpng -r300 figs/pop_GS_rings_small_bio_c

pcomps_cbar(diaz_bio_a.mean,norm_ssh_a.mean,[0 2e-7],-1,.1,1,['Diaz SS',char(39) char(39),' AC'],1,20)
print -dpng -r300 figs/pop_GS_rings_diaz_bio_a
pcomps_cbar(diaz_bio_c.mean,norm_ssh_c.mean,[0 2e-7],-1,.1,1,['Diaz SS',char(39) char(39),' CC'],1,20)
print -dpng -r300 figs/pop_GS_rings_diaz_bio_c

pcomps_cbar(diat_bio_a.mean,norm_ssh_a.mean,[0 2e-5],-1,.1,1,['Diat SS',char(39) char(39),' AC'],1,20)
print -dpng -r300 figs/pop_GS_rings_diat_bio_a
pcomps_cbar(diat_bio_c.mean,norm_ssh_c.mean,[0 2e-5],-1,.1,1,['Diat SS',char(39) char(39),' CC'],1,20)
