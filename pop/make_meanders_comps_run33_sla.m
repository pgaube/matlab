...
% 
% 
load GS_core_meanders_run33_sla
% % 
...
% m[chl_a,dd,chl_c,rr]=pop_comps_mat_run33(stream_eddies.x,stream_eddies.y,stream_eddies.cyc,stream_eddies.k,stream_eddies.id,stream_eddies.track_jday,stream_eddies.radius,stream_eddies.adens,'total_chl',1,'n');
...
% % % [w_a,dd,w_c,dd]= pop_comps(stream_eddies.x,stream_eddies.y,stream_eddies.cyc,stream_eddies.k,stream_eddies.id,stream_eddies.track_jday,stream_eddies.radius,stream_eddies.adens,'wvel_104','/Volumes/d1/larrya/public_html/0pt1/output_run33/t.33.',1,0);
save -append pop_meanders_run33
return
% 
