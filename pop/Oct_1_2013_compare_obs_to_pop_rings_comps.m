...
pcomps_raw2(obs_chl_a.mean,obs_ssh_a.mean,[-.2 .2],-100,5,100,'Observed CHL AC',1,20)
print -dpng -r300 figs/observed_GS_rings_chl_ssh_a
pcomps_raw2(obs_chl_c.mean,obs_ssh_c.mean,[-.2 .2],-100,5,100,'Observed CHL CC',1,20)
print -dpng -r300 figs/observed_GS_rings_chl_ssh_c


pcomps_raw2(obs_ssh_a.mean,obs_ssh_a.mean,[-50 50],-100,5,100,'Observed SSH AC',1,20)
print -dpng -r300 figs/observed_GS_rings_ssh_ssh_a
pcomps_raw2(obs_ssh_c.mean,obs_ssh_c.mean,[-50 50],-100,5,100,'Observed SSH CC',1,20)
print -dpng -r300 figs/observed_GS_rings_ssh_ssh_c

load pop_rings_comps
pcomps_raw2(norm_hp66_chl_a.mean,ssh_a.mean,[-.3 .3],-100,5,100,'POP CHL AC',1,20)
print -dpng -r300 figs/pop_GS_rings_chl_ssh_a
pcomps_raw2(norm_hp66_chl_c.mean,ssh_c.mean,[-.3 .3],-100,5,100,'POP CHL CC',1,20)
print -dpng -r300 figs/pop_GS_rings_chl_ssh_c

pcomps_raw2(ssh_a.mean,ssh_a.mean,[-50 50],-100,5,100,'POP SSH AC',1,20)
print -dpng -r300 figs/pop_GS_rings_ssh_ssh_a
pcomps_raw2(ssh_c.mean,ssh_c.mean,[-50 50],-100,5,100,'POP SSH CC',1,20)
...
load obs_rings_comps
ts_a=smooth1d_loess(obs_chl_a.ks_05,1:length(obs_chl_a.ks_05),6,1:12);
std_ts_a=smooth1d_loess(obs_chl_a.ks_std_05,1:1:length(obs_chl_a.ks_05),6,1:12);
n_ts_a=obs_chl_a.ks_n(1:12);

ts_c=smooth1d_loess(obs_chl_c.ks_05,1:length(obs_chl_c.ks_05),6,1:12);
std_ts_c=smooth1d_loess(obs_chl_c.ks_std_05,1:1:length(obs_chl_c.ks_05),6,1:12);
