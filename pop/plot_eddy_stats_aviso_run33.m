...
load GS_rings_cor_tracks_run_33_jan_5
pop_eddies.amp=amp;
...
print -dpng -r300 figs/histos_rings_amps_run_33_jan_5
...
print -dpng -r300 figs/histos_rings_scale_run_33_jan_5
...
% set(gca,'xtick',[10:20:100])
title('AVISO')
text(12,40,['Anticyclones ',num2str(round(10*pmean(aviso_eddies.lt(aviso_eddies.cc==1)))./10),' weeks'],'fontsize',10,'color','r')
text(12,35,['    Cyclones ',num2str(round(10*pmean(aviso_eddies.lt(aviso_eddies.cc==-1)))./10),' weeks'],'fontsize',10,'color','b')
...
% set(gca,'xtick',[10:20:100])
title('POP')
text(12,40,['Anticyclones ',num2str(round(10*pmean(pop_eddies.lt(pop_eddies.cc==1)))./10),' weeks'],'fontsize',10,'color','r')
text(12,35,['    Cyclones ',num2str(round(10*pmean(pop_eddies.lt(pop_eddies.cc==-1)))./10),' weeks'],'fontsize',10,'color','b')
...
print -dpng -r300 figs/histos_rings_age_run_33_jan_5
