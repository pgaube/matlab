...
%%relative to orgin
% [ss_chl_orgin_a,ss_chl_orgin_c]=pop_comps_rel_orgin_mat(stream_eddies.x,stream_eddies.y,stream_eddies.cyc,stream_eddies.k,stream_eddies.id,stream_eddies.track_jday,50,'ss66_chl');
...
% [mask_chl_orgin_a,mask_chl_orgin_c]=pop_comps_rel_orgin_mat(stream_eddies.x,stream_eddies.y,stream_eddies.cyc,stream_eddies.k,stream_eddies.id,stream_eddies.track_jday,50,'mask_hp66_chl');
...
% [ss66_chl_a,dd,ss66_chl_c,rr]=pop_comps_mat(stream_eddies.x,stream_eddies.y,stream_eddies.cyc,stream_eddies.k,stream_eddies.id,stream_eddies.track_jday,stream_eddies.radius,stream_eddies.adens,'ss66_chl',1,'n');
% [mask_norm_hp66_chl_a,dd,mask_norm_hp66_chl_c,rr]=pop_comps_mat(stream_eddies.x,stream_eddies.y,stream_eddies.cyc,stream_eddies.k,stream_eddies.id,stream_eddies.track_jday,stream_eddies.radius,stream_eddies.adens,'mask_hp66_chl',1,'dd');
...
[norm_hp66_c_a,dd,norm_hp66_c_c,rr]=pop_comps_mat(stream_eddies.x,stream_eddies.y,stream_eddies.cyc,stream_eddies.k,stream_eddies.id,stream_eddies.track_jday,stream_eddies.radius,stream_eddies.adens,'hp66_biomass',1,'cc');
