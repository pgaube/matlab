...
% % close all
load ~/matlab/pop/mat/mean_chl_run33 mean_chl
load ~/matlab/pop/mat/mean_mdt_run33
...
% % load tmp_dcdn_run33
% mag_grad=smooth2d_loess(sqrt(dcdx.^2+dcdy.^2),lon(1,:),lat(:,1),4,4,lon(1,:),lat(:,1)).*mask;
% % 
...
% save tmp_dcdn_run33 dcdn chl_bar su sv dcdx dcdy mag_grad
% load tmp_dcdn_run33
% % return
% st=10;
...
% print -dpng -r300 figs/mean_gchl_and_streamlines_run33

load tmp_dcdn_run33
load pop_bec_cor_0_run33_gridded slon slat tr0
rref=.12
...
print -dpng -r300 figs/dcdn_run_33
