clear all
load mean_gs_path_obs_pop_run_33 lons lats std_lats mean std
...
stream_eddies.adens(stream_eddies.cyc==-1)=1;
% 
%%%now aplly eastward only criteria
...
save GS_core_meanders_run33_sla stream_eddies
...
print -dpng -r300 figs/gs_meanders_tracks_run33_sla
