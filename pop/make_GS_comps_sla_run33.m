...
[chl_a,dd,chl_c,rr]=pop_comps_mat_run33(stream_eddies.x,stream_eddies.y,stream_eddies.cyc,stream_eddies.k,stream_eddies.id,stream_eddies.track_jday,stream_eddies.radius,stream_eddies.adens,'total_chl',1,'n');
...
save -append pop_gs_sla_run33
return




%%%%IF USING SOUTH OF HERE, FIX
