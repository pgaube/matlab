...
for m=1:length(uid)
    ...
    if any(ii&jj)
        ...
        eval(['print -dpng -r300 figs/pdens/meander_week1_',num2str(uid(m))])
        ...
        eval(['print -dpng -r300 figs/pdens/meander_week5_',num2str(uid(m))])
...
dist=dist(1:60);
save zonal_dens_sections_meanders z dist pd1 pd4 apd1 apd4 
...
print -dpng -r300 figs/pdens/means
