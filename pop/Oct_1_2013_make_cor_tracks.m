...
adens(cyc==1)=-1;
adens(cyc==-1)=1;
save tmp_cor_tracks x y k id cyc adens amp track_jday radius
save rings_cor_tracks x y k id cyc adens amp track_jday radius
...
eval(['save ',curs{mm},'_cor_tracks x y k id cyc radius track_jday amp adens'])
...
xlabel([num2str(numa),' anticyclones, ',num2str(numm),' MWE, ',num2str(numc),' cyclones, ',num2str(numt),' thinnies, '])
eval(['save ',curs{mm},'_cor_orgin_tracks x y k id cyc radius track_jday amp adens igood iorgin'])
...
xlabel([num2str(numa),' anticyclones, ',num2str(numm),' MWE, ',num2str(numc),' cyclones, ',num2str(numt),' thinnies, '])
eval(['save ',curs{mm},'_cor_tracks x y k id radius cyc track_jday amp adens igood iorgin'])
title(['All tracks that transvers in region, r=',num2str(rref),' contoured'])
