...
load pop_bec_cor_0_run14_gridded
...
[r,c]=imap(minlat,maxlat,min(slon(1,:)),max(slon(1,:)),lat,lon);
mask=mask1(r,c);
...
figure(1)
clf
pmap(slon,slat,r0,'gs')
colormap(bwr)
caxis([-.75 .75])
hold on
m_contour(slon,slat,sm_r0,[-rref rref],'k')
...
figure(2)
clf
pmap(slon,slat,r0a,'gs')
colormap(bwr)
caxis([-.75 .75])
hold on
m_contour(slon,slat,sm_r0a,[-rref rref],'k')
ax=m_plot(smoothn(lons,10),smoothn(lats,10),'k','linewidth',2);
m_plot(smoothn(lons,10),smoothn(lats-bs,10),'k--','linewidth',1)
m_plot(smoothn(lons,10),smoothn(lats+as,10),'k--','linewidth',1)
...
figure(3)
clf
pmap(slon,slat,r0c,'gs')
colormap(bwr)
caxis([-.75 .75])
hold on
m_contour(slon,slat,sm_r0c,[-rref rref],'k')
ax=m_plot(smoothn(lons,10),smoothn(lats,10),'k','linewidth',2);
m_plot(smoothn(lons,10),smoothn(lats-bs,10),'k--','linewidth',1)
m_plot(smoothn(lons,10),smoothn(lats+as,10),'k--','linewidth',1)
...
figure(4)
clf
pmap(slon,slat,r0t,'gs')
colormap(bwr)
caxis([-.75 .75])
hold on
m_contour(slon,slat,sm_r0t,[-rref rref],'k')
ax=m_plot(smoothn(lons,10),smoothn(lats,10),'k','linewidth',2);
m_plot(smoothn(lons,10),smoothn(lats-bs,10),'k--','linewidth',1)
m_plot(smoothn(lons,10),smoothn(lats+as,10),'k--','linewidth',1)
...
figure(5)
clf
pmap(slon,slat,r0n,'gs')
colormap(bwr)
caxis([-.75 .75])
hold on
m_contour(slon,slat,sm_r0n,[-rref rref],'k')
ax=m_plot(smoothn(lons,10),smoothn(lats,10),'k','linewidth',2);
m_plot(smoothn(lons,10),smoothn(lats-bs,10),'k--','linewidth',1)
m_plot(smoothn(lons,10),smoothn(lats+as,10),'k--','linewidth',1)
