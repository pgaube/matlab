...
%%%%%The following adjust the length of the obs. SSH record to 292 5-day
%%%%%weeks, same as POP
njdays=njdays(1:292);
...
load tmp_pop_ssh
% pop_grid_eddies=track_eddies_MDT(slon,slat,jdays_tmp,aMDT,aSSH,.25);
% pop_grid_eddies.track_jday=jday2pday(pop_grid_eddies.track_jday);
% pop_grid_eddies.jday=jday2pday(pop_grid_eddies.jday);
% 
...
% 
save -append GS_rings_tracks_run14_sla pop_eddies
return

save GS_rings_tracks_run14_mdt
...
pop_eddies=track_eddies_MDT(plon,plat,jdays_tmp,pSSH,pMDT,.1);
pop_eddies.track_jday=jday2pday(pop_eddies.track_jday);
...
save GS_rings_tracks_run33_sla
