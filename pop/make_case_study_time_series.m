...
orgin_vars={'chl_orgin','ssh_orgin','small_c_orgin','diat_c_orgin','diaz_c_orgin','hp_small_c_orgin','hp_diat_c_orgin','hp_diaz_c_orgin',...
    'tnh4_orgin','tno3_orgin','tpo4_orgin','nh4_orgin','no3_orgin','po4_orgin','bio_small_orgin','bio_diat_orgin','bio_diaz_orgin'};

for m=1:length(vars)
    
    eval(['ts_a=',vars{m},'_a.ks_05(1:tend);'])
    eval(['std_ts_a=',vars{m},'_a.ks_std_05(1:tend);'])
    eval(['n_ts_a=',vars{m},'_a.ks_n(1:tend);'])
    
    eval(['ts_c=',vars{m},'_c.ks_05(1:tend);'])
...
%     patch(xp,xts_c,[.8 .8 .8])
    ...
    box
    title(vars{m})
    eval(['print -dpng -r300 figs/00_case_study_ts/',vars{m},'_ts'])
end
...
%     patch(xp,xts_c,[.8 .8 .8])
    ...
    box
    title(orgin_vars{m})
    eval(['print -dpng -r300 figs/00_case_study_ts/',orgin_vars{m},'_ts'])
end
...
a_small_na=smooth1d_loess(sp_c_a.kd_05,1:length(sp_c_a.kd_05),5,dft)./max(sp_c_a.kd_05);
a_diat_na=smooth1d_loess(diat_c_a.kd_05,1:length(diat_c_a.kd_05),5,dft)./max(diat_c_a.kd_05);
a_diaz_na=smooth1d_loess(diaz_c_a.kd_05,1:length(diaz_c_a.kd_05),5,dft)./max(diaz_c_a.kd_05);
...
c_small_na=smooth1d_loess(sp_c_c.kd_05,1:length(sp_c_c.kd_05),5,dft)./max(sp_c_c.kd_05);
c_diat_na=smooth1d_loess(diat_c_c.kd_05,1:length(diat_c_c.kd_05),5,dft)./max(diat_c_c.kd_05);
c_diaz_na=smooth1d_loess(diaz_c_c.kd_05,1:length(diaz_c_c.kd_05),5,dft)./max(diaz_c_c.kd_05);
...
set(gca,'ylim',[.1 .7],'xlim',[1 12],'fontsize',10,'fontweight','bold','LineWidth',.5,'TickLength',[.01 .05],'layer','top')
xlabel('weeks')
print -dpng -r300 figs/case_study_ts/rings_diveristy_kd_05_L
return
% 
% %%%%
% % Diaz SS
% %%%%
% ts_a=smooth1d_loess(diaz_pp_a.kd_05,1:length(diaz_pp_a.kd_05),6,1:tend);
% std_ts_a=smooth1d_loess(diaz_pp_a.ks_std_05,1:1:length(diaz_pp_a.kd_05),6,1:tend);
% n_ts_a=diaz_pp_a.ks_n(1:tend);
% 
% ts_c=smooth1d_loess(diaz_pp_c.kd_05,1:length(diaz_pp_c.kd_05),6,1:tend);
% std_ts_c=smooth1d_loess(diaz_pp_c.ks_std_05,1:1:length(diaz_pp_c.kd_05),6,1:tend);
...
% % Diat SS
% %%%%
% ts_a=smooth1d_loess(diat_pp_a.kd_05,1:length(diat_pp_a.kd_05),6,1:tend);
% std_ts_a=smooth1d_loess(diat_pp_a.ks_std_05,1:1:length(diat_pp_a.kd_05),6,1:tend);
% n_ts_a=diat_pp_a.ks_n(1:tend);
% 
% ts_c=smooth1d_loess(diat_pp_c.kd_05,1:length(diat_pp_c.kd_05),6,1:tend);
% std_ts_c=smooth1d_loess(diat_pp_c.ks_std_05,1:1:length(diat_pp_c.kd_05),6,1:tend);
...
% % Small
% %%%%
% ts_a=smooth1d_loess(small_vadv_a.kd_05,1:length(small_vadv_a.kd_05),6,1:tend);
% std_ts_a=smooth1d_loess(small_vadv_a.ks_std_05,1:1:length(small_vadv_a.kd_05),6,1:tend);
% n_ts_a=small_vadv_a.ks_n(1:tend);
% 
% ts_c=smooth1d_loess(small_vadv_c.kd_05,1:length(small_vadv_c.kd_05),6,1:tend);
% std_ts_c=smooth1d_loess(small_vadv_c.ks_std_05,1:1:length(small_vadv_c.kd_05),6,1:tend);
...
% % Diaz
% %%%%
% ts_a=smooth1d_loess(diaz_vadv_a.kd_05,1:length(diaz_vadv_a.kd_05),6,1:tend);
% std_ts_a=smooth1d_loess(diaz_vadv_a.ks_std_05,1:1:length(diaz_vadv_a.kd_05),6,1:tend);
% n_ts_a=diaz_vadv_a.ks_n(1:tend);
% 
% ts_c=smooth1d_loess(diaz_vadv_c.kd_05,1:length(diaz_vadv_c.kd_05),6,1:tend);
% std_ts_c=smooth1d_loess(diaz_vadv_c.ks_std_05,1:1:length(diaz_vadv_c.kd_05),6,1:tend);
...
% % Diat
% %%%%
% ts_a=smooth1d_loess(diat_vadv_a.kd_05,1:length(diat_vadv_a.kd_05),6,1:tend);
% std_ts_a=smooth1d_loess(diat_vadv_a.ks_std_05,1:1:length(diat_vadv_a.kd_05),6,1:tend);
% n_ts_a=diat_vadv_a.ks_n(1:tend);
% 
% ts_c=smooth1d_loess(diat_vadv_c.kd_05,1:length(diat_vadv_c.kd_05),6,1:tend);
% std_ts_c=smooth1d_loess(diat_vadv_c.ks_std_05,1:1:length(diat_vadv_c.kd_05),6,1:tend);
...
% %%%%%%%%%%%%%%%%
% 
% ts_a=smooth1d_loess(w_a.kd_05,1:length(w_a.kd_05),6,1:tend);
% std_ts_a=smooth1d_loess(w_a.ks_std_05,1:1:length(w_a.kd_05),6,1:tend);
% n_ts_a=w_a.ks_n(1:tend);
% 
% ts_c=smooth1d_loess(w_c.kd_05,1:length(w_c.kd_05),6,1:tend);
% std_ts_c=smooth1d_loess(w_c.ks_std_05,1:1:length(w_c.kd_05),6,1:tend);
...
% % Small SS
% %%%%
% ts_a=smooth1d_loess(small_bio_a.kd_05,1:length(small_bio_a.kd_05),6,1:tend);
% std_ts_a=smooth1d_loess(small_bio_a.ks_std_05,1:1:length(small_bio_a.kd_05),6,1:tend);
% n_ts_a=small_bio_a.ks_n(1:tend);
% 
% ts_c=smooth1d_loess(small_bio_c.kd_05,1:length(small_bio_c.kd_05),6,1:tend);
% std_ts_c=smooth1d_loess(small_bio_c.ks_std_05,1:1:length(small_bio_c.kd_05),6,1:tend);
...
% % Diaz SS
% %%%%
% ts_a=smooth1d_loess(diaz_bio_a.kd_05,1:length(diaz_bio_a.kd_05),6,1:tend);
% std_ts_a=smooth1d_loess(diaz_bio_a.ks_std_05,1:1:length(diaz_bio_a.kd_05),6,1:tend);
% n_ts_a=diaz_bio_a.ks_n(1:tend);
% 
% ts_c=smooth1d_loess(diaz_bio_c.kd_05,1:length(diaz_bio_c.kd_05),6,1:tend);
% std_ts_c=smooth1d_loess(diaz_bio_c.ks_std_05,1:1:length(diaz_bio_c.kd_05),6,1:tend);
...
% % Diat SS
% %%%%
% ts_a=smooth1d_loess(diat_bio_a.kd_05,1:length(diat_bio_a.kd_05),6,1:tend);
% std_ts_a=smooth1d_loess(diat_bio_a.ks_std_05,1:1:length(diat_bio_a.kd_05),6,1:tend);
% n_ts_a=diat_bio_a.ks_n(1:tend);
% 
% ts_c=smooth1d_loess(diat_bio_c.kd_05,1:length(diat_bio_c.kd_05),6,1:tend);
% std_ts_c=smooth1d_loess(diat_bio_c.ks_std_05,1:1:length(diat_bio_c.kd_05),6,1:tend);
...
% % % % Small biomass
% % % %%%%
% % % ts_a=smooth1d_loess(norm_hp66_sp_c_a.kd_05,1:length(norm_hp66_sp_c_a.kd_05),6,1:tend);
% % % std_ts_a=smooth1d_loess(norm_hp66_sp_c_a.ks_std_05,1:1:length(norm_hp66_sp_c_a.kd_05),6,1:tend);
% % % n_ts_a=norm_hp66_sp_c_a.ks_n(1:tend);
% % % 
% % % ts_c=smooth1d_loess(norm_hp66_sp_c_c.kd_05,1:length(norm_hp66_sp_c_c.kd_05),6,1:tend);
% % % std_ts_c=smooth1d_loess(norm_hp66_sp_c_c.ks_std_05,1:1:length(norm_hp66_sp_c_c.kd_05),6,1:tend);
...
% % % % Diaz biomass
% % % %%%%
% % % ts_a=smooth1d_loess(norm_hp66_diaz_c_a.kd_05,1:length(norm_hp66_diaz_c_a.kd_05),6,1:tend);
% % % std_ts_a=smooth1d_loess(norm_hp66_diaz_c_a.ks_std_05,1:1:length(norm_hp66_diaz_c_a.kd_05),6,1:tend);
% % % n_ts_a=norm_hp66_diaz_c_a.ks_n(1:tend);
% % % 
% % % ts_c=smooth1d_loess(norm_hp66_diaz_c_c.kd_05,1:length(norm_hp66_diaz_c_c.kd_05),6,1:tend);
% % % std_ts_c=smooth1d_loess(norm_hp66_diaz_c_c.ks_std_05,1:1:length(norm_hp66_diaz_c_c.kd_05),6,1:tend);
...
% % % % Diat biomass
% % % %%%%
% % % ts_a=smooth1d_loess(norm_hp66_diat_c_a.kd_05,1:length(norm_hp66_diat_c_a.kd_05),6,1:tend);
% % % std_ts_a=smooth1d_loess(norm_hp66_diat_c_a.ks_std_05,1:1:length(norm_hp66_diat_c_a.kd_05),6,1:tend);
% % % n_ts_a=norm_hp66_diat_c_a.ks_n(1:tend);
% % % 
% % % ts_c=smooth1d_loess(norm_hp66_diat_c_c.kd_05,1:length(norm_hp66_diat_c_c.kd_05),6,1:tend);
% % % std_ts_c=smooth1d_loess(norm_hp66_diat_c_c.ks_std_05,1:1:length(norm_hp66_diat_c_c.kd_05),6,1:tend);
...
% % % % CHL
% % % %%%%
% % % ts_a=smooth1d_loess(norm_hp66_chl_a.kd_05,1:length(norm_hp66_chl_a.kd_05),6,1:tend);
% % % std_ts_a=smooth1d_loess(norm_hp66_chl_a.ks_std_05,1:1:length(norm_hp66_chl_a.kd_05),6,1:tend);
% % % n_ts_a=norm_hp66_chl_a.ks_n(1:tend);
% % % 
% % % ts_c=smooth1d_loess(norm_hp66_chl_c.kd_05,1:length(norm_hp66_chl_c.kd_05),6,1:tend);
% % % std_ts_c=smooth1d_loess(norm_hp66_chl_c.ks_std_05,1:1:length(norm_hp66_chl_c.kd_05),6,1:tend);
...
% % % SSH
% % % %%%
% % % ts_a=smooth1d_loess(ssh_a.kd_05,1:length(ssh_a.kd_05),6,1:tend);
% % % std_ts_a=smooth1d_loess(ssh_a.ks_std_05,1:1:length(ssh_a.kd_05),6,1:tend);
% % % n_ts_a=ssh_a.ks_n(1:tend);
% % % 
% % % ts_c=smooth1d_loess(ssh_c.kd_05,1:length(ssh_c.kd_05),6,1:tend);
% % % std_ts_c=smooth1d_loess(ssh_c.ks_std_05,1:1:length(ssh_c.kd_05),6,1:tend);
...
% % set(gca,'ylim',[.2 .5],'xlim',[1 16],'fontsize',10,'fontweight','bold','LineWidth',.5,'TickLength',[.01 .05],'layer','top')
% % xlabel('weeks')
% % print -dpng -r300 figs/rings_diveristy_kd_05_L
