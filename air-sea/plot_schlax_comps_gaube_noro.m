clear all
load ULTI_wind_midlat_rot_comps noro* w*
load bwr.pal
...
tit=['W_{cur} AC N=',num2str(noro_w_ek_total_qscat_a.n_max_sample)];
...
tit=['W_{SST} AC N=',num2str(noro_w_ek_total_qscat_a.n_max_sample)];
...
tit=['W_{cur} CC N=',num2str(noro_w_ek_total_qscat_c.n_max_sample)];
...
tit=['W_{SST} CC N=',num2str(noro_w_ek_total_qscat_c.n_max_sample)];
...
box
box
text(-7,8,'GAUBE GLOB NOT ROTATED')

print -dpng -r300 /Users/new_gaube/Documents/Publications/gaube_chelton_sst_wind_eddies/figs/schalx_compare/gaube_final_figs/GAUBE_wind_midlat_comps_noro
