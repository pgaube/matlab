...
load /matlab/data/eddy/V4/air-sea_agu_lat_lon_tracks

%[AGU_wek_a,AGU_wek_c]=mcomps('/matlab/data/eddy/V4/air-sea_agu_lat_lon_tracks','nrw_ek_sample','n');
...
flc='AGU_wek_crlg_c_with_wek_crlg';
