...
% 	load([fsave_path qsave_head num2str(jdays(m))],'hp_wek_sst_week_dtdn','hp_wek_crlg_week')
...
% 	ddo=ddo+1;
	...
	eval(['save -append ',[fsave_path qsave_head num2str(jdays(m))],' hp_wek_sst_week_dtdn'])
