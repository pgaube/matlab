...
load /matlab/matlab/domains/larry_kur_lat_lon
load /matlab/data/eddy/V4/larry_kur_lat_lon_tracks

%[KUR_wek_a,KUR_wek_c]=mcomps('/matlab/data/eddy/V4/larry_kur_lat_lon_tracks','nrw_ek_sample','n');
%[KUR_sst_a,KUR_sst_c]=mcomps('/matlab/data/eddy/V4/larry_kur_lat_lon_tracks','nrbp26_sst_sample','n');
%[KUR_ssh_a,KUR_ssh_c]=mcomps('/matlab/data/eddy/V4/larry_kur_lat_lon_tracks','nrssh_sample','n');
%[KUR_raw_a,KUR_raw_c]=mcomps('/matlab/data/eddy/V4/larry_kur_lat_lon_tracks','nrraw_hp66_chl_sample','n');
%[KUR_wek_crlg_a,KUR_wek_crlg_c]=mcomps('/matlab/data/eddy/V4/larry_kur_lat_lon_tracks','nrhp_wek_crlg_week_sample','n');
[KUR_crlg_a,KUR_crlg_c]=mcomps('/matlab/data/eddy/V4/larry_kur_lat_lon_tracks','nrbp26_crlg_sample','n');
%[KUR_wek_sst_a,KUR_wek_sst_c]=mcomps('/matlab/data/eddy/V4/larry_kur_lat_lon_tracks','nrhp_wek_sst_week_sample','n');
%[KUR_wek_drift_a,KUR_wek_drift_c]=mcomps('/matlab/data/eddy/V4/larry_kur_lat_lon_tracks','nrhp_wek_drift_week_sample','n');
%[KUR_wek_all_a,KUR_wek_all_c]=mcomps('/matlab/data/eddy/V4/larry_kur_lat_lon_tracks','nrhp_wek_total_week_sample','n');
save -append KUR_comps 
...
cplot_comps_cont_2_2(1e5*tmp,tmp2,-.4,.4,2,-100,100,'AVISO @MAiD@ u_g^ Cyclones',...
	['~/Documents/OSU/figures/air-sea/KUR_comps/',flc]) 
...
cplot_comps_cont_2_2_bwr(tmp,tmp2,-3,3,1,-100,100,'AVISO Ekman Upwelling',...
	['~/Documents/OSU/figures/air-sea/KUR_comps/',fla]) 
...
cplot_comps_cont_2_2_bwr(tmp,tmp2,-3,3,1,-10,10,'SST-induced Ekman Downwelling',...
	['~/Documents/OSU/figures/air-sea/KUR_comps/',flc]) 
...
cplot_comps_cont_2_2_bwr(tmp,tmp2,-3,3,1,-10,10,'SST-induced Ekman Upwelling',...
	['~/Documents/OSU/figures/air-sea/KUR_comps/',fla]) 
%{	
