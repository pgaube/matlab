...
sst=smoothn(double(bp26_sst_S_cc.mean),5); %deg c
sst=sst./max(abs(sst(:)));
...
% eval(['print -dpng -r300 /Users/new_gaube/Documents/Publications/gaube_chelton_sst_wind_eddies/figs/scam/FINAL/c_sh_crl_scam_',num2str(a(m)),'.png'])
% 
% pcomps_raw2(fillnans(fsst),fillnans(fsst),[-.3 .3],-10,.05,10,'',1,30)
% eval(['print -dpng -r300 /Users/new_gaube/Documents/Publications/gaube_chelton_sst_wind_eddies/figs/scam/FINAL/c_sh_sst_scam_',num2str(a(m)),'.png'])
a(m)=-0.1
