...
u_rel=interp2(zgrid(real_lon,real_lat,0,0,double(u_w-u),L/1000),'linear');
v_rel=interp2(zgrid(real_lon,real_lat,0,0,double(v_w-v),L/1000),'linear');
...
box
print -dpng -r300 /Users/new_gaube/Documents/Proposals/OVWST/2013/figs/vec_scam_u_rel
...
plot(x(1,:),y(1,:),'k','linewidth',1.5)
box
print -dpng -r300 /Users/new_gaube/Documents/Proposals/OVWST/2013/figs/vec_scam_u_o
...
line([0 0],[-2 2],'color','k','LineWidth',1.5)
box
print -dpng -r300 /Users/new_gaube/Documents/Proposals/OVWST/2013/figs/vec_scam_u_w
...
%plot(x(1,:),y(1,:),'k','linewidth',1.5)
box
print -dpng -r300 /Users/new_gaube/Documents/Proposals/OVWST/2013/figs/vec_scam_wek
return
