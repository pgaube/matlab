...
wl_e=1./(1020*(ff)).*crl_tau.*8640000;
wn_e=(1/1020)*(1./(ff).^2).*((tau_x.*dcdy)-(tau_y.*dcdx)).*8640000;
wb_e=(1/1020)*(1./(ff).^2)*(tau_x.*bb).*8640000;
w_ek_e=wl_e+wn_e+wb_e;
...
pcomps_raw2(w_ek_c_e,w_ek_c_e,[-6 6],-100,.5,100,'',2,30)
eval(['print -dpng -r300 /Users/new_gaube/Documents/Publications/gaube_chelton_sst_wind_eddies/figs/scam/FINAL/c_wek_e_c_scam_',num2str(a(m)),'.png'])

pcomps_raw2(w_ek_c_n,w_ek_c_n,[-6 6],-100,.5,100,'',2,30)
eval(['print -dpng -r300 /Users/new_gaube/Documents/Publications/gaube_chelton_sst_wind_eddies/figs/scam/FINAL/c_wek_n_c_scam_',num2str(a(m)),'.png'])

pcomps_raw2(w_ek_z_e,w_ek_z_e,[-6 6],-100,.5,100,'',2,30)
eval(['print -dpng -r300 /Users/new_gaube/Documents/Publications/gaube_chelton_sst_wind_eddies/figs/scam/FINAL/c_wek_e_z_scam_',num2str(a(m)),'.png'])

pcomps_raw2(w_ek_z_n,w_ek_z_n,[-6 6],-100,.5,100,'',2,30)
eval(['print -dpng -r300 /Users/new_gaube/Documents/Publications/gaube_chelton_sst_wind_eddies/figs/scam/FINAL/c_wek_n_z_scam_',num2str(a(m)),'.png'])

pcomps_raw2(w_ek_b_e,w_ek_b_e,[-6 6],-100,.5,100,'',2,30)
eval(['print -dpng -r300 /Users/new_gaube/Documents/Publications/gaube_chelton_sst_wind_eddies/figs/scam/FINAL/c_wek_e_b_scam_',num2str(a(m)),'.png'])

pcomps_raw2(w_ek_b_n,w_ek_b_n,[-6 6],-100,.5,100,'',2,30)
eval(['print -dpng -r300 /Users/new_gaube/Documents/Publications/gaube_chelton_sst_wind_eddies/figs/scam/FINAL/c_wek_n_b_scam_',num2str(a(m)),'.png'])
