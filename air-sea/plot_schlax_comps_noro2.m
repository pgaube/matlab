clear all
schlax={'SCHLAX_wind_NH_comps_noro','SCHLAX_wind_SH_comps_noro','SCHLAX_wind_midlat_comps_noro'};
gaube={'ULTI_wind_NH_comps','ULTI_wind_SH_comps','ULTI_wind_midlat_rot_comps'};
head={'SCHLAX NH NOT ROTATED','SCHLAX SH NOT ROTATED','SCHLAX GLOB NOT ROTATED'};
out={'SCHLAX_wind_NH_comps_noro','SCHLAX_wind_SH_comps_noro','SCHLAX_wind_midlat_comps_noro'};

for m=1:3
eval(['load ',schlax{m},' w*'])
eval(['load ',gaube{m},' noro_w_ek_total_qscat*'])
...
%%w_tot_ac
imag=1.07*double(interp2(noro_w_ek_total_qscat_a.mean));
tit=['W_{tot} AC N=',num2str(w_ek_total_qscat_a.n_max_sample)];
ax=subplot(231);
...
%%w_tot_ac
imag=1.03*double(interp2(noro_w_ek_total_qscat_c.mean));
tit=['W_{tot} CC N=',num2str(w_ek_total_qscat_c.n_max_sample)];
ax=subplot(232);
...
% print -dpng -r300 /Users/new_gaube/Documents/Publications/gaube_chelton_sst_wind_eddies/figs/schalx_compare/gaube_final_figs/SCHLAX_wind_NH_comps_noro2
end