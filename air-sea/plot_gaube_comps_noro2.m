...
head={'GAUBE NH NOT ROTATED','GAUBE SH NOT ROTATED','GAUBE GLOB NOT ROTATED'};
out={'GAUBE_wind_NH_comps_noro','GAUBE_wind_SH_comps_noro','GAUBE_wind_midlat_comps_noro'};

for m=1:3
eval(['load ',gaube{m},' no*'])
% clear w_ek_total_qscat*
% load test_wek
load bwr.pal
...
imag=double(interp2(noro_w_ek_total_a.mean));
...
%%w_tot_ac
imag=double(interp2(noro_w_ek_total_qscat_a.mean));
tit=['W_{tot} AC N=',num2str(noro_w_ek_total_qscat_a.n_max_sample)];
ax=subplot(231);
...
%%w_cur_ac
imag=double(interp2(noro_w_ek_total_a.mean));
tit=['W_{cur} AC N=',num2str(noro_w_ek_total_a.n_max_sample)];
...
%%w_sst_ac
imag=double(interp2((.013/.01)*noro_w_ek_sst_fixed_a.mean));
tit=['W_{SST} AC N=',num2str(noro_w_ek_sst_fixed_a.n_max_sample)];
...
%%w_tot_ac
imag=double(interp2(noro_w_ek_total_qscat_c.mean));
tit=['W_{tot} CC N=',num2str(noro_w_ek_total_qscat_c.n_max_sample)];
ax=subplot(232);
...
%%w_cur_ac
imag=double(interp2(noro_w_ek_total_c.mean));
tit=['W_{cur} CC N=',num2str(noro_w_ek_total_c.n_max_sample)];
...
%%w_sst_ac
imag=double(interp2((.013/.01)*noro_w_ek_sst_fixed_c.mean));
tit=['W_{SST} CC N=',num2str(noro_w_ek_sst_fixed_c.n_max_sample)];
...
% print -dpng -r300 /Users/new_gaube/Documents/Publications/gaube_chelton_sst_wind_eddies/figs/schalx_compare/gaube_final_figs/GAUBE_wind_NH_comps_noro2
end