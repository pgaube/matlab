...
figure(1)
clf
pmap(lon(r,c),lat(r,c),median_wek_crlg(r,c).*mask(r,c))
caxis([0 8])
draw_air_sea_regions
...
figure(2)
clf
pmap(lon(r,c),lat(r,c),(ff(r,c)./fo).*median_wek_crlg(r,c).*mask(r,c))
caxis([0 8])
draw_air_sea_regions
...
figure(2)
clf
pmap(lon(r,c),lat(r,c),(ff(r,c)./fo).*median_wek_sst(r,c).*mask(r,c))
caxis([0 8])
draw_air_sea_regions
