...
text(2.9,4,'Northern Hemisphere Composite Averages','HorizontalAlignment','center','fontsize',38)
...
print -dpng -r300 ~/Documents/Publications/gaube_chelton_sst_wind_eddies/figs/NH_wek_comps
