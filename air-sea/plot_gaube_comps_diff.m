clear all
% close all
load ULTI_wind_midlat_rot_comps w*
load bwr.pal
...
tit=['W_{cur}+W_{SST} AC N=',num2str(w_ek_total_qscat_a.n_max_sample)];
...
%%diff ac
dd=w_ek_total_a.mean-(w_ek_total_qscat_a.mean-(.013/.01)*w_ek_sst_fixed_a.mean);
imag=double(interp2(dd));
tit=['diff AC N=',num2str(w_ek_total_qscat_a.n_max_sample)];
...
tit=['W_{cur}+W_{SST} CC N=',num2str(w_ek_total_qscat_c.n_max_sample)];
...
dd=w_ek_total_c.mean-(w_ek_total_qscat_c.mean-(.013/.01)*w_ek_sst_fixed_c.mean);
imag=double(interp2(dd));
tit=['diff CC N=',num2str(w_ek_total_qscat_c.n_max_sample)];
