...
[cwspd,   cdwspddx, cdwspddy, ...
 ...
 cdivstr, ccrlstr,  cdstrmds, cdstrmdn, cu3] = deal(zeros(ny,nx,'uint8'));
[swspd,   sdwspddx, sdwspddy, ...
 ...
 sdivstr, scrlstr,  sdstrmds, sdstrmdn, su3] = deal(zeros(ny,nx,'single'));
...
%   [svdstrmdy,cvdstrmdy]= sumcnt_work_function(vdstrmdy,svdstrmdy,cvdstrmdy);
   ...
   if ~isempty(DAILY_AVG_OUTPUT_DIR) & ...
       ...
       save(Doutname,'Du3','Dwspd','Dstrm','Du','Dv','Dustr','Dvstr', ...
