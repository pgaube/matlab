...
TOP_LEVEL_DIR = '/matlab/data/QuickScat/';
...
OI_DIR = ['/matlab/data/ReynoldsSST/mat/'];
OI_HEAD='OI_25_D_';
...
SSMI_ICE_FILE_DIR =  '/home/wallaby/data/pgaube/data/ssmi/month/';
