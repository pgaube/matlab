...
for m=1:length(jdays)
    for n=-10:10
    	...
    	fname = ['S' num2str(date) '.L3m_DAY_POC_poc_9km'];
   	    fnameg = ['S' num2str(date) '.L3m_DAY_POC_poc_9km.bz2'];
        ...
        if n==10
           ...
           %drawnow
           chl_day=nan*chl_day;
           eval(['save -append ' save_path 'SCHL_9_21_' num2str(jdays(m)) ...
                 ' gpoc_week poc_week lat lon jdays glon glat']);
