...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% $Id: nc_attget.m 2748 2009-06-23 18:35:05Z johnevans007 $
% $LastChangedDate: 2009-06-23 14:35:05 -0400 (Tue, 23 Jun 2009) $
...
switch(backend)
	case 'hdf5'
		values = nc_attget_hdf5(ncfile,varname,attribute_name);
	case 'tmw'
