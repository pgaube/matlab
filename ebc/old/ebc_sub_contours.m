...
clf
hax=subplot(431);
text(.1,.5,{'Cyclones','Image of Horz Normalized SSH with SST Contours'})
set(hax,'visible','off')
hax=subplot(434)
pcolor(double(BG_comp_nssh_cycl(22:36,22:36)));shading interp;axis image
...
colormap(chelle)
hold on
[c,h]=contour(double(BG_comp_nfamsre_cycl(22:36,22:36)),'k');
clabel(c,h);
...
hax=subplot(437)
pcolor(double(LW_comp_nssh_cycl(22:36,22:36)));shading interp;axis image
set(hax,'xtick',1:4:15,'ytick',1:4:15,'xticklabel',abs(-1.75:1.75),'yticklabel',abs(-1.75:1.75),'xminortick','on','yminortick','on')
...
colormap(chelle)
hold on
[c,h]=contour(double(LW_comp_nfamsre_cycl(22:36,22:36)),'k');
clabel(c,h);
line([0 15],[8 8],'color','k')
line([8 8],[0 15],'color','k')
title({'Leeuwin'})
...
pcolor(double(CCN_comp_nssh_cycl(22:36,22:36)));shading interp;axis image
set(hax,'xtick',1:4:15,'ytick',1:4:15,'xticklabel',abs(-1.75:1.75),'yticklabel',abs(-1.75:1.75),'xminortick','on','yminortick','on')
...
colormap(chelle)
hold on
[c,h]=contour(double(CCN_comp_nfamsre_cycl(22:36,22:36)),'k');
clabel(c,h);
line([0 15],[8 8],'color','k')
line([8 8],[0 15],'color','k')
...
pcolor(double(CCS_comp_nssh_cycl(22:36,22:36)));shading interp;axis image
set(hax,'xtick',1:4:15,'ytick',1:4:15,'xticklabel',abs(-1.75:1.75),'yticklabel',abs(-1.75:1.75),'xminortick','on','yminortick','on')
...
pcolor(double(PCN_comp_nssh_cycl(22:36,22:36)));shading interp;axis image
set(hax,'xtick',1:4:15,'ytick',1:4:15,'xticklabel',abs(-1.75:1.75),'yticklabel',abs(-1.75:1.75),'xminortick','on','yminortick','on')
...
colormap(chelle)
hold on
[c,h]=contour(double(PCN_comp_nfamsre_cycl(22:36,22:36)),'k');
clabel(c,h);
line([0 15],[8 8],'color','k')
line([8 8],[0 15],'color','k')
...
pcolor(double(PCS_comp_nssh_cycl(22:36,22:36)));shading interp;axis image
set(hax,'xtick',1:4:15,'ytick',1:4:15,'xticklabel',abs(-1.75:1.75),'yticklabel',abs(-1.75:1.75),'xminortick','on','yminortick','on')
...
colormap(chelle)
hold on
[c,h]=contour(double(PCS_comp_nfamsre_cycl(22:36,22:36)),'k');
clabel(c,h);
line([0 15],[8 8],'color','k')
line([8 8],[0 15],'color','k')
...
pcolor(double(IB_comp_nssh_cycl(22:36,22:36)));shading interp;axis image
set(hax,'xtick',1:4:15,'ytick',1:4:15,'xticklabel',abs(-1.75:1.75),'yticklabel',abs(-1.75:1.75),'xminortick','on','yminortick','on')
...
colormap(chelle)
hold on
[c,h]=contour(double(IB_comp_nfamsre_cycl(22:36,22:36)),'k');
clabel(c,h);
line([0 15],[8 8],'color','k')
line([8 8],[0 15],'color','k')
title({'Iberian'})
...
pcolor(double(ME_comp_nssh_cycl(22:36,22:36)));shading interp;axis image
set(hax,'xtick',1:4:15,'ytick',1:4:15,'xticklabel',abs(-1.75:1.75),'yticklabel',abs(-1.75:1.75),'xminortick','on','yminortick','on')
...
colormap(chelle)
hold on
[c,h]=contour(double(ME_comp_nfamsre_cycl(22:36,22:36)),'k');
clabel(c,h);
line([0 15],[8 8],'color','k')
line([8 8],[0 15],'color','k')
title({'Mediterranean'})
...
pcolor(double(CC_comp_nssh_cycl(22:36,22:36)));shading interp;axis image
set(hax,'xtick',1:4:15,'ytick',1:4:15,'xticklabel',abs(-1.75:1.75),'yticklabel',abs(-1.75:1.75),'xminortick','on','yminortick','on')
...
colormap(chelle)
hold on
[c,h]=contour(double(CC_comp_nfamsre_cycl(22:36,22:36)),'k');
clabel(c,h);
line([0 15],[8 8],'color','k')
line([8 8],[0 15],'color','k')
title({'Canary'})
