...
[BG_comp_nfamsre_anti,BG_comp_nfamsre_cycl]=comps('/Volumes/matlab/matlab/ebc/BG_lat_lon_tracks_16_weeks.mat','nfamsre_sample');
[BG_comp_nssh_anti,BG_comp_nssh_cycl]=comps('/Volumes/matlab/matlab/ebc/BG_lat_lon_tracks_16_weeks.mat','nssh_sample');
...
set(cc,'yaxislocation','right')
ylabel('^{\circ}C')
eval(['print -dpng ~/Documents/OSU/classes/EB09/project/figs/comps/BG/nfamsre_anti_d_16']) 


figure(3)
clf
hax=axes;
pcolor(double(BG_comp_nfamsre_cycl(22:36,22:36)));shading interp;axis image
...
set(cc,'yaxislocation','right')
ylabel('^{\circ}C')
eval(['print -dpng ~/Documents/OSU/classes/EB09/project/figs/comps/BG/nfamsre_close_cycl_d_16']) 

figure(4)
clf
hax=axes;
pcolor(double(BG_comp_nfamsre_anti(22:36,22:36)));shading interp;axis image
set(hax,'xtick',1:2:15,'ytick',1:2:15,'xticklabel',abs(-1.75:.5:1.75),'yticklabel',abs(-1.75:.5:1.75),'xminortick','on','yminortick','on')
ylabel({'normalized distance from eddy centroid'})
xlabel({,'normalized distance from eddy centroid'})
%rotateticklabel(hax,90);
...
set(cc,'yaxislocation','right')
ylabel('^{\circ}C')
eval(['print -dpng ~/Documents/OSU/classes/EB09/project/figs/comps/BG/nfamsre_close_anti_d_16']) 


save BG_nfamsre_comps BG*
