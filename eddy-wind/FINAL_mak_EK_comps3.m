...
%     eval(['fbc=double(interp2(',fbc,'));'])
%     eval(['fbc2=double(interp2(',fbc2,'));'])
%     pcomps(fbc,fbc2,[-.004 .004],-1,.01,1,[mon(n,:),' N=',num2str(lab)])
%     eval(['print -depsc ~/Documents/OSU/figures/eddy-wind/FINAL_comps/sp66_chl/lw_',num2str(n),'_a']) 
% 
%     fbc=['lw','_',num2str(n),'_chl_c.median'];
%     fbc2=['lw','_',num2str(n),'_wek_c.median'];
%     nn=['lw','_',num2str(n),'_chl_c.n_max_sample'];
...
%     eval(['lab=num2str(', nn,');'])
%     pcomps(fbc,fbc2,[-.004 .004],-1,.01,1,[mon(n,:),' N=',num2str(lab)])
%     eval(['print -depsc ~/Documents/OSU/figures/eddy-wind/FINAL_comps/sp66_chl/lw_',num2str(n),'_c'])
%     
