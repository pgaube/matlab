clear all
load bwr.pal
load EK_new_comps winter_a
x=linspace(-2,2,49);
y=x;
sst=smoothn(double(winter_a.sst_median),3); %deg c
h = smoothn(double(winter_a.ssh_median),3)./100; %m
...
'/Users/gaube/Documents/OSU/figures/eddy-wind/scam_03_deg_c/a_wek_dir_scam_tot',num2str(m),char(39),')'])

eval(['cplot_comps_cont_2_2_bwr(w_ek_sst,w_ek_sst,-10,10,1,-100,100,',char(39),...
'W_E^ from SST anomaly',char(39),',',char(39),...
'/Users/gaube/Documents/OSU/figures/eddy-wind/scam_03_deg_c/a_wek_dir_scam_sst',num2str(m),char(39),')'])

eval(['cplot_comps_cont_2_2_bwr(w_ek,w_ek,-10,10,1,-100,100,',char(39),...
'W_E^ from Gaussian eddy currents',char(39),',',char(39),...
'/Users/gaube/Documents/OSU/figures/eddy-wind/scam_03_deg_c/a_wek_dir_scam_cur',num2str(m),char(39),')'])
...
cplot_comps_cont_2_2_bwr(nanmean(comp_wek,3),nanmean(comp_wek,3),-10,10,1,-100,100,'W_E^ averaged by 15 deg','/Users/gaube/Documents/OSU/figures/eddy-wind/scam_03_deg_c/a_rotating_wk_scam')
...
%}
cplot_comps_cont_2_2(1e5*crl,h,-.8,.8,.02,-2,2,'Gaussian eddy geostrophic vorticity','/Users/gaube/Documents/OSU/figures/eddy-wind/scam_03_deg_c/a_crl_scam')
cplot_comps_cont_2_2(sst,sst,-.5,.5,.1,-2,2,'eddy SST anomaly','/Users/gaube/Documents/OSU/figures/eddy-wind/scam_03_deg_c/a_sst_scam')
cplot_comps_cont_2_2(sst,h,-.5,.5,.02,-1,1,'eddy SST anomaly','/Users/gaube/Documents/OSU/figures/eddy-wind/scam_03_deg_c/a_sst_h_scam')
cplot_comps_cont_2_2_bwr(w_ek_sst,w_ek_sst,-10,10,1,-100,100,'W_E^ from eddy SST anomaly','/Users/gaube/Documents/OSU/figures/eddy-wind/scam_03_deg_c/a_wek_sst_scam')
