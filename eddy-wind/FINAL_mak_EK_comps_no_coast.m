...
%     
    ...
    eval(['print -dpng -r300 ~/Documents/OSU/figures/eddy-wind/FINAL_comps/no_coast_sp66_chl/lw_',num2str(n),'_a']) 
    ...
    eval(['lab=num2str(', nn,');'])
    pcomps_raw(fbc,fbc2,[-.006 .006],-1,.01,1,[mon(n,:),' N=',num2str(lab)],1,50)
    eval(['print -dpng -r300 ~/Documents/OSU/figures/eddy-wind/FINAL_comps/no_coast_sp66_chl/lw_',num2str(n),'_c'])
