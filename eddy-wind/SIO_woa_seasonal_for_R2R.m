...
%scatter(st_w(:),in_w(:),'g.','linewidth',4)
axis([ 0 5 0 210])
set(gca,'fontsize',15,'LineWidth',3,'TickLength',[.025 .5],'layer','top','YAxisLocation','left','xtick',[0:5])
xlabel('mmol m^{-3} or 2 x 10^{-7}kg m^{-4}','fontsize',15,'fontweight','bold')
%ylabel('m','fontsize',25,'fontweight','bold')
text(-.4,-12,'         [$NO_3^-$] and $\frac{\partial\sigma_\theta}{\partial z}$','fontsize',22,'fontweight','bold','Interpreter', 'Latex')
box
axis ij
legend('winter','summer','location',[.7 .5 .07 .15])
legend boxoff

print -depsc /Users/new_gaube/Documents/Publications/gaube_chelton_eddy_wind/figures/mean_n_s_profile_r2r.eps
fixPSlinestyle('/Users/new_gaube/Documents/Publications/gaube_chelton_eddy_wind/figures/mean_n_s_profile_r2r.eps','/Users/new_gaube/Documents/Publications/gaube_chelton_eddy_wind/figures/mean_n_s_profile2_r2r.eps')
!open /Users/new_gaube/Documents/Publications/gaube_chelton_eddy_wind/figures/mean_n_s_profile_r2r.eps
!open /Users/new_gaube/Documents/Publications/gaube_chelton_eddy_wind/figures/mean_n_s_profile2_r2r.eps
return
