...
load pCC_eddy_argo_prof.mat   
load /matlab/data/eddy/V4/full_tracks/pCC_lat_lon_tracks.mat lon lat nneg prop_speed amp scale track_jday id amp axial_speed
...
drawnow
print -dpng -r300 figs/3d/pCC_profile_map
...
print -dpng -r300 figs/3d/pCC_profile_loc_comps
...
colormap(chelle)
print -dpng -r300 figs/3d/pCC_sigma
...
axes(cc)
ylabel('(cm s^{-1})')
print -dpng -r300 figs/3d/pCC_gvel
...
print -dpng -r300 figs/3d/pCC_u_over_c
...
colorbar
colormap(chelle)
print -dpng -r300 figs/3d/pCC_speed_plan
...
axes(cc)
ylabel('(m s^{-1})')
print -dpng -r300 figs/3d/pCC_gvel_4_way
...
axes(cc)
ylabel('^\circ C')
print -dpng -r300 figs/3d/pCC_tmp_anom
...
axes(cc)
ylabel('PSU')
print -dpng -r300 figs/3d/pCC_sal_anom
...
axes(cc)
ylabel('\sigma_\theta (kg m^{-3})')
print -dpng -r300 figs/3d/pCC_sigma_anom
...
line([0 0],[-2.5 2.5],'color','k')
caxis([-1 1])
print -dpng -r300 figs/3d/pCC_temp_slices
...
line([0 0],[-2.5 2.5],'color','k')
caxis([-10 10])
print -dpng -r300 figs/3d/pCC_sal_slices
...
line([0 0],[-2.5 2.5],'color','k')
%caxis([-.2 .2])
print -dpng -r300 figs/3d/pCC_sal_dens
return
...
caxis([-0 10])
colorbar
print -dpng -r300 figs/3d/pCC_horz_tmp_sal
...
ylabel('(m s^{-1})')
warning('on','all')
print -dpng -r300 figs/3d/pCC_chan_fig_5_merid
...
ylabel('(m s^{-1})')
warning('on','all')
print -dpng -r300 figs/3d/pCC_chan_fig_5