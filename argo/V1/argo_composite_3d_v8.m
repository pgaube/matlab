...
save iVOCALS_eddy_argo_prof.mat eddy_* *woa* nneg ppres lat lon ia ic sigma_* tpres


clear
load iVOCALS_eddy_argo_prof
...
save iVOCALS_argo_3d ac_* cc_* ppres xi yi
fprintf('\n')

%}
clear
load iVOCALS_argo_3d
