...
load /matlab/data/eddy/V4/full_tracks/pCC_lat_lon_tracks.mat lon lat nneg

load pCC_eddy_argo_prof eddy_dist_x eddy_dist_y eddy_ist eddy_x eddy_y eddy_id
...
drawnow
print -dpng -r300 figs/pCC_profile_map
...
axes(cc)
ylabel('^\circ C')
print -dpng -r300 figs/pCC_tmp_anom
...
axes(cc)
ylabel('PSU')
print -dpng -r300 figs/pCC_sal_anom
...
axes(cc)
ylabel('\sigma_\theta (kg m^{-3})')
print -dpng -r300 figs/pCC_sigma_anom
...
axes(cc)
ylabel('(m s^{-1})')
print -dpng -r300 figs/pCC_gvel_4_way
...
axes(cc)
ylabel('(m s^{-1})')
print -dpng -r300 figs/pCC_gvel_from_t
return
...
line([0 0],[-2.5 2.5],'color','k')
caxis([-1 1])
print -dpng -r300 figs/pCC_temp_slices
...
line([0 0],[-2.5 2.5],'color','k')
caxis([-10 10])
print -dpng -r300 figs/pCC_sal_slices
...
line([0 0],[-2.5 2.5],'color','k')
%caxis([-.2 .2])
print -dpng -r300 figs/pCC_sal_dens
return
...
caxis([-0 10])
colorbar
print -dpng -r300 figs/pCC_horz_tmp_sal
...
ylabel('(m s^{-1})')
warning('on','all')
print -dpng -r300 figs/pCC_chan_fig_5_merid
...
ylabel('(m s^{-1})')
warning('on','all')
print -dpng -r300 figs/pCC_chan_fig_5