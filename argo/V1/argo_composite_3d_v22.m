...
tbins=min(eddy_it(:)):.2:max(eddy_it(:));
sbins=min(eddy_is(:)):.5:max(eddy_is(:));
...
for m=1:length(tbins)-1
	...
	std_as_t_s_ac(m,:)=prctile(ac_is(ii),[15 85]);
	std_as_t_t_ac(m,:)=prctile(ac_it(ii),[15 85]);
	
	ii=find(cc_it>=tbins(m) & cc_it<tbins(m+1));	
	std_as_t_s_cc(m,:)=prctile(cc_is(ii),[15 85]);
	std_as_t_t_cc(m,:)=prctile(cc_it(ii),[15 85]);
end	

for m=1:length(sbins)-1
	ii=find(ac_is>=sbins(m) & ac_is<sbins(m+1));
	std_as_s_t_ac(m,:)=prctile(ac_it(ii),[15 85]);
	std_as_s_s_ac(m,:)=prctile(ac_is(ii),[15 85]);
	
	ii=find(cc_is>=sbins(m) & cc_is<sbins(m+1));	
	std_as_s_t_cc(m,:)=prctile(cc_it(ii),[15 85]);
	std_as_s_s_cc(m,:)=prctile(cc_is(ii),[15 85]);
end	

std_as_t_s_ac(:,1)=smooth1d_loess(std_as_t_s_ac(:,1),[1:length(tbins)-1]',30,[1:length(tbins)-1]');
std_as_t_s_ac(:,2)=smooth1d_loess(std_as_t_s_ac(:,2),[1:length(tbins)-1]',30,[1:length(tbins)-1]');
std_as_t_s_cc(:,1)=smooth1d_loess(std_as_t_s_cc(:,1),[1:length(tbins)-1]',30,[1:length(tbins)-1]');
std_as_t_s_cc(:,2)=smooth1d_loess(std_as_t_s_cc(:,2),[1:length(tbins)-1]',30,[1:length(tbins)-1]');
std_as_t_t_ac(:,1)=smooth1d_loess(std_as_t_t_ac(:,1),[1:length(tbins)-1]',30,[1:length(tbins)-1]');
std_as_t_t_ac(:,2)=smooth1d_loess(std_as_t_t_ac(:,2),[1:length(tbins)-1]',30,[1:length(tbins)-1]');
std_as_t_t_cc(:,1)=smooth1d_loess(std_as_t_t_cc(:,1),[1:length(tbins)-1]',30,[1:length(tbins)-1]');
std_as_t_t_cc(:,2)=smooth1d_loess(std_as_t_t_cc(:,2),[1:length(tbins)-1]',30,[1:length(tbins)-1]');

std_as_s_t_ac(:,1)=smooth1d_loess(std_as_s_t_ac(:,1),[1:length(sbins)-1]',30,[1:length(sbins)-1]');
std_as_s_t_ac(:,2)=smooth1d_loess(std_as_s_t_ac(:,2),[1:length(sbins)-1]',30,[1:length(sbins)-1]');
std_as_s_t_cc(:,1)=smooth1d_loess(std_as_s_t_cc(:,1),[1:length(sbins)-1]',30,[1:length(sbins)-1]');
std_as_s_t_cc(:,2)=smooth1d_loess(std_as_s_t_cc(:,2),[1:length(sbins)-1]',30,[1:length(sbins)-1]');
std_as_s_s_ac(:,1)=smooth1d_loess(std_as_s_s_ac(:,1),[1:length(sbins)-1]',30,[1:length(sbins)-1]');
std_as_s_s_ac(:,2)=smooth1d_loess(std_as_s_s_ac(:,2),[1:length(sbins)-1]',30,[1:length(sbins)-1]');
std_as_s_s_cc(:,1)=smooth1d_loess(std_as_s_s_cc(:,1),[1:length(sbins)-1]',30,[1:length(sbins)-1]');
std_as_s_s_cc(:,2)=smooth1d_loess(std_as_s_s_cc(:,2),[1:length(sbins)-1]',30,[1:length(sbins)-1]');
...
percent_s_retained=100*(length(find(~isnan(eddy_is)))/sbad)
percent_t_retained=100*(length(find(~isnan(eddy_it)))/tbad)
