...
%load /matlab/data/eddy/V4/full_tracks/EIO_lat_lon_tracks.mat lon lat nneg prop_speed

c_spd=pmean(prop_speed)/100;


load EIO_eddy_argo_prof eddy_dist_x eddy_dist_y eddy_ist eddy_x eddy_y eddy_id eddy_ist ia ic
...
drawnow
print -dpng -r300 figs/2d/EIO_profile_map
...
print -dpng -r300 figs/2d/EIO_profile_loc_comps
...
axes(cc)
ylabel('^\circ C')
print -dpng -r300 figs/2d/EIO_tmp_anom
...
axes(cc)
ylabel('PSU')
print -dpng -r300 figs/2d/EIO_sal_anom
...
axes(cc)
ylabel('\sigma_\theta (kg m^{-3})')
print -dpng -r300 figs/2d/EIO_sigma_anom
...
print -dpng -r300 figs/2d/EIO_gvel_histo
...
ylabel('(m s^{-1})')
print -dpng -r300 figs/2d/EIO_gvel
...
print -dpng -r300 figs/2d/EIO_u_over_c
