...
load /matlab/data/eddy/V4/full_tracks/dCC_lat_lon_tracks.mat lon lat nneg prop_speed

c_spd=pmean(prop_speed)/100;


load dCC_eddy_argo_prof eddy_dist_x eddy_dist_y eddy_ist eddy_x eddy_y eddy_id eddy_ist ia ic
