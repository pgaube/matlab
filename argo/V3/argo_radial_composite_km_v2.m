function argo_radial_composite_km(input_track_file,input_domain,outname)
...
eval(['save ' outname, '_argo_mask_km_ext_comp.mat ac_* cc_* *_woa ppres ri dlat dlon km_x step ff eddy_dist ia ic prop_speed nda ndc eddy_*'])
fprintf('\n')
