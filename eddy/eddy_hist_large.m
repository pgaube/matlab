...
clf
hax=subplot(231)
stairs(cpdf,'b','linewidth',1)

hold on
stairs(apdf,'r','linewidth',1)
...
[bar_rad,num_rad]=phist(efold(ci),t_bins);
h = num_rad./sum(num_rad);
%pdf = h/.5;
cpdf = h*100;

[bar_rad,num_rad]=phist(efold(ai),t_bins);
h = num_rad./sum(num_rad);
%pdf = h/.5;
apdf = h*100;
