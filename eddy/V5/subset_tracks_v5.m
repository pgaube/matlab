function subset_tracks_v5(DOMAIN)
...
%subset by space
tii = find(x>=min_lon & x<=max_lon & y>=min_lat & y<=max_lat);
tun=unique(id(tii));
...
clearallbut id eid amp axial_speed scale track_jday x y k cyc unique_id ai ci DOMAIN DPATH
