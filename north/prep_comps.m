...
mask_maj2=nan*north_spd_c.N(r,c);
mask_min2=nan*north_spd_c.N(r,c);
mask_maj2((north_spd_c.N(r,c)./north_spd_c.n_max_sample)>=.1)=1;
mask_min2(north_spd_c.N(r,c)>=100)=1;
tmp2 = double(north_spd_c.mean(r,c).*mask_min2);
...
cplot_comps(tmp,-.5,.5, ...
	'~/Documents/OSU/figures/north/north_comp_rnfoi_c_transect_bg')
cplot_comps(tmp2,-.008,.008, ...
	'~/Documents/OSU/figures/north/north_comp_spd_c_transect_bg')	

tmp = double(north_rnfoi_c.mean(r,c).*mask_maj);
tmp2 = double(north_spd_c.mean(r,c).*mask_maj2);

cplot_comps_cont_w_line(tmp,tmp,l_noc(1,:),l_noc(2,:),-.5,.5,-.35, ...
	'~/Documents/OSU/figures/north/north_comp_rnfoi_c_transect')
cplot_comps_cont_w_line(tmp2,tmp,l_noc(1,:),l_noc(2,:),-.008,.008,-.35, ...
	'~/Documents/OSU/figures/north/north_comp_spd_c_transect')	
...
mask_maj2=nan*north_spd_a.N(r,c);
mask_min2=nan*north_spd_a.N(r,c);
mask_maj2((north_spd_a.N(r,c)./north_spd_a.n_max_sample)>=.1)=1;
mask_min2(north_spd_a.N(r,c)>=100)=1;
tmp2 = double(north_spd_a.mean(r,c).*mask_min2);
...
cplot_comps(tmp,-.5,.5, ...
	'~/Documents/OSU/figures/north/north_comp_rnfoi_a_transect_bg')
cplot_comps(tmp2,-.008,.008, ...
	'~/Documents/OSU/figures/north/north_comp_spd_a_transect_bg')	

tmp = double(north_rnfoi_a.mean(r,c).*mask_maj);
tmp2 = double(north_spd_a.mean(r,c).*mask_maj2);

cplot_comps_cont_w_line(tmp,tmp,l_noa(1,:),l_noa(2,:),-.5,.5,.45, ...
	'~/Documents/OSU/figures/north/north_comp_rnfoi_a_transect')
cplot_comps_cont_w_line(tmp2,tmp,l_noa(1,:),l_noa(2,:),-.008,.008,.45, ...
	'~/Documents/OSU/figures/north/north_comp_spd_a_transect')	
...
mask_maj2=nan*south_spd_c.N(r,c);
mask_min2=nan*south_spd_c.N(r,c);
mask_maj2((south_spd_c.N(r,c)./south_spd_c.n_max_sample)>=.1)=1;
mask_min2(south_spd_c.N(r,c)>=100)=1;
tmp2 = double(south_spd_c.mean(r,c).*mask_min2);
...
cplot_comps(tmp2,-.008,.008, ...
	'~/Documents/OSU/figures/south/south_comp_spd_c_transect_bg')	
...
cplot_comps_cont_line(tmp2,tmp,l_soc(1,:),l_soc(2,:),-.008,.008,-.35, ...
	'~/Documents/OSU/figures/south/south_comp_spd_c_transect')	
...
mask_maj2=nan*south_spd_a.N(r,c);
mask_min2=nan*south_spd_a.N(r,c);
mask_maj2((south_spd_a.N(r,c)./south_spd_a.n_max_sample)>=.1)=1;
mask_min2(south_spd_a.N(r,c)>=100)=1;
tmp2 = double(south_spd_a.mean(r,c).*mask_min2);
...
cplot_comps(tmp2,-.008,.008, ...
	'~/Documents/OSU/figures/south/south_comp_spd_a_transect_bg')	
...
cplot_comps_cont_line(tmp,tmp,l_soa(1,:),l_soa(2,:),-.5,.5,.45, ...
	'~/Documents/OSU/figures/north/south_comp_rnfoi_a_transect')
cplot_comps_cont_line(tmp2,tmp,l_soa(1,:),l_soa(2,:),-.008,.008,.45, ...
	'~/Documents/OSU/figures/north/south_comp_spd_a_transect')	
