...
cplot_comps(tmp2,-.25,.25, ...
	'~/Documents/OSU/figures/south/north_comp_spd_c_transect_bg')	
...
cplot_comps_cont_w_line(tmp2,tmp,l_noc(1,:),l_noc(2,:),-.25,.25,.35,-.7,-.35, ...
	'~/Documents/OSU/figures/south/north_comp_spd_c_transect')	
...
cplot_comps(tmp2,-.25,.25, ...
	'~/Documents/OSU/figures/south/north_comp_spd_a_transect_bg')	
...
cplot_comps_cont_w_line(tmp2,tmp,l_noa(1,:),l_noa(2,:),-.25,.25,.45,.45,.9, ... 
	'~/Documents/OSU/figures/south/north_comp_spd_a_transect')	
...
cplot_comps_cont_w_line(tmp2,tmp,l_soa(1,:),l_soa(2,:),-.25,.25,.45,.45,.9, ... 
	'~/Documents/OSU/figures/south/south_comp_spd_a_transect')	
	
cplot_yy_r_b(t_noc,t_noa,t_nsc,t_nsa,-.5,.5,.1,-.25,.25,.1,2,...
	'deg c','m s^{-2}','~/Documents/OSU/figures/south/transects/north_spd')
cplot_yy_r_b(t_soc,t_soa,t_ssc,t_ssa,-.5,.5,.1,-.25,.25,.1,2,....
	'deg c','m s^{-2}','~/Documents/OSU/figures/south/transects/south_spd')